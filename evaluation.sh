...
mvn clean install exec:java -Dexec.mainClass="org.apdplat.evaluation.Evaluator" -Dexec.args="target/cws_evaluation-1.2.jar -testText=data/test-text.txt -standardText=data/standard-text.txt StanfordEvaluation"
